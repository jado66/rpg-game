...
public static class GameItemDatabase
{
    static List<GameItem> items = new List<GameItem>();

    public static List<GameItem> blacksmithItems = new List<GameItem>();
    public static List<GameItem> alchemistItems = new List<GameItem>();
    public static List<GameItem> farmerItems = new List<GameItem>();
    public static List<GameItem> craftsmanItems = new List<GameItem>();
    public static List<GameItem> collectorItems = new List<GameItem>();
    public static List<GameItem> generalItems = new List<GameItem>();

    public static Dictionary<string, PlantData> plantDatabase;
    public static Dictionary<string, BluePrint> bluePrintDatabase;

    static GameItemDatabase()
    {
        BuildDatabase();
        BuildPlantDatabase();
    ...
    {
        var tool = GameItem.Uses.tool;
        var interactable = GameItem.Uses.interactable;
        var consumable = GameItem.Uses.consumable;
        var wearable = GameItem.Uses.wearable;
        var regularItem = GameItem.Uses.regularItem;
...
// Definitions for GameItem subclasses
public class RegularItem : GameItem
{
...
public class InteractableItem : GameItem
{
...
public class WearableItem : GameItem
{
